...
def try_methods():
    ...
    first_turtle.pen = rg.Pen('brown', 5)
    first_turtle.forward(150)
    first_turtle.left(90)
    first_turtle.forward(50)
    first_turtle.backward(100)
...
def try_methods_and_functions():
    ...
    second_turtle.backward(150)

    second_turtle.speed = 1
    draw_many_squares(second_turtle, 2, 100, 30)

    second_turtle.speed = 5
    second_turtle.pen = rg.Pen('red', 5)
    draw_many_squares(second_turtle, 10, 50, 15)

    second_turtle.speed = 100
    second_turtle.pen = rg.Pen('red', 35)
    draw_many_squares(second_turtle, 8, 300, 60)

    second_turtle.pen = rg.Pen('black', 3)
    second_turtle.backward(200)

    second_turtle.draw_circle(30)

    second_turtle.draw_square(50)
