...
def main():
    ...
    # even_better_draw_circles(rg.Point(100,50), 5, 15, 'brown', 2)
    # even_better_draw_circles(rg.Point(-200, 0), 25, 20, 'green', 5)

    even_better_draw_circles(rg.Point(-200, 50), 25, 15, 'blue', 3)
    even_better_draw_circles(rg.Point(200, 50), 25, 15, 'blue', 3)

    even_better_draw_circles(rg.Point(0, -200), 10, 5, 'green', 5)
    even_better_draw_circles(rg.Point(75, -180), 10, 5, 'green', 5)
    even_better_draw_circles(rg.Point(-75, -180), 10, 5, 'green', 5)
    even_better_draw_circles(rg.Point(150, -150), 10, 5, 'green', 5)
    even_better_draw_circles(rg.Point(-150, -150), 10, 5, 'green', 5)

    even_better_draw_circles(rg.Point(-200, 50), 5, 15, 'red', 1)
    even_better_draw_circles(rg.Point(200, 50), 5, 15, 'red', 1)
...
def better_draw_circles(point, increase):
    ...
    for k in range(1, 11):  # k becomes 1, 2, 3, ... 10
        ...
        # Go DOWN parameter # of pixels, ending up pointing east again
        turtle.right(90)
...
def even_better_draw_circles(point, increase, num_circles, color, thickness):
